...
CREATE TABLE Employees (
    ...
    projectHoursTotal DECIMAL(10, 4) NOT NULL DEFAULT 0
);
...
CREATE TABLE EmployeePositions (
    termID INT NOT NULL UNIQUE AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE ProjectEmployees (
    ...
    hoursWorkedTotal DECIMAL(10, 4) NOT NULL DEFAULT 0,
    FOREIGN KEY (employeeID) REFERENCES Employees(employeeID) ON DELETE CASCADE,
    FOREIGN KEY (projectID) REFERENCES Projects(projectID) ON DELETE CASCADE,
    CONSTRAINT employeeProject UNIQUE (employeeID, projectID)
);
